<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="WebApplication10_1114.WebForm2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:imConnectionString %>" DeleteCommand="DELETE FROM [product] WHERE [Id] = @Id" InsertCommand="INSERT INTO [product] ([Id], [name], [price], [type]) VALUES (@Id, @name, @price, @type)" SelectCommand="SELECT * FROM [product] WHERE ([Id] = @Id)" UpdateCommand="UPDATE [product] SET [name] = @name, [price] = @price, [type] = @type WHERE [Id] = @Id">
                <DeleteParameters>
